					...
					<div class="card " >
						...
						<div class="card-body border border-dark">
							<form name="my-form" action="FarmerLogin.php" method="post">
								...
								<br>
								<div class="col-md-6 offset-md-4">
									<label id="forgotPassword"><a id='link' style="" href="FarmerForgotPassword.php"><b style="color:black;position:absolute;left:3%;font-size:15px;"> Forgot your password ?</b></a></label>
									<br>
									<label id="account" ><a id='link' href="FarmerRegister.php"><b style="color:black;font-size:15px;"> Create New Account</b></a></label>
								</div>
							</form>
						</div>
					</div>
